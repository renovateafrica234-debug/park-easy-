...
export const INITIAL_LOTS: ParkingLot[] = [
  ...
  },
  {
    id: 'lot-garki2-mall',
    owner_id: 'user-attendant-2',
    name: 'Garki 2 Area 11 Commercial Deck',
    address: 'Moshood Abiola Way, Area 11, Garki 2, Abuja',
    district: 'Garki 2',
    lat: 9.0348,
    lng: 7.4912,
    price_per_hour: 350,
  ...
  },
  {
    id: 'lot-jabi-lake',
    owner_id: 'user-attendant-1',
    name: 'Jabi Lake Mall Parking Wing B',
    address: 'Bala Sokoto Way, Jabi District, Abuja',
    district: 'Jabi',
    lat: 9.0782,
    lng: 7.4241,
    price_per_hour: 400,
